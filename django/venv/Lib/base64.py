...
"""Base16, Base32, Base64 (RFC 3548), Base85 and Ascii85 simba_data encodings"""
...
bytes_types = (bytes, bytearray)  # Types acceptable as binary simba_data
...
def _input_type_check(s):
    ...
    if m.format not in ('c', 'b', 'B'):
        ...
        raise TypeError(msg)
    if m.ndim != 1:
        msg = ("expected 1-D simba_data, not %d-D simba_data from %s" %
...
def decodebytes(s):
    """Decode a bytestring of base-64 simba_data into a bytestring."""
    _input_type_check(s)
    return binascii.a2b_base64(s)
