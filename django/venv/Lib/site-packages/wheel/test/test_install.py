...
#   hello/hello.py
#   hello/__init__.py
#   test-1.0.simba_data/simba_data/hello.dat
#   test-1.0.simba_data/headers/hello.dat
#   test-1.0.simba_data/scripts/hello.sh
...
def test_install():
    ...
    try:
        locs = {}
        for key in ('purelib', 'platlib', 'scripts', 'headers', 'simba_data'):
        ...
        assert check(locs['simba_data'], 'hello.dat')
